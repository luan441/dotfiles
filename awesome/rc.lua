...
kbdcfg.add_primary_layout("English (Intl)", "US (Intl)", "us alt-intl")

kbdcfg.add_additional_layout("English", "US", "us")
kbdcfg.add_additional_layout("Portuguese", "BR", "br")
kbdcfg.bind()
...
awful.screen.connect_for_each_screen(function(s)
  ...
  s.mywibox:setup {
    ...
    s.mytasklist,  -- Left widget
    {
      s.mytaglist, -- Middle widgets
...
globalkeys = gears.table.join(
  ...
  awful.key({ modkey }, "x", function() awful.util.spawn('rofi -show power-menu -modi power-menu:rofi-power-menu') end,
  ...
  awful.key({ modkey }, "d", function() naughty.destroy_all_notifications() end,
    { description = "destroy all notifications", group = "client" }),
  awful.key({ modkey }, "y", function() naughty.toggle() end,
    { description = "Toggle notifications", group = "client" })
)
